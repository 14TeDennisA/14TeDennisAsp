...
//  private boolean[] isVisible;
  ...
  private ArrayList<Ex01> collisionCandidates = new ArrayList<Ex01>();
   ...
   */
  public Ex01(boolean isRotatable, String filename)
  {
    String[] imagePathes = new String[1];
    imagePathes[0] = filename;
   ...
   */
  public Ex01(boolean isRotatable, String... filenames)
  {
   ...
   */
  public Ex01(String filename, int nbSprites)
  {
    String[] imagePathes = new String[1];
    imagePathes[0] = filename;
   ...
   * @param nbSprites the number of sprite images for the same actor
   */
  public Ex01(boolean isRotatable, String filename, int nbSprites)
  {
    String[] imagePathes = new String[1];
    imagePathes[0] = filename;
   ...
   */
  public void nearBorder(Ex01 actor, Location location)
  {
  }
   ...
   */
  public void addCollisionCandidate(Ex01 partner)
  {
   ...
   */
  public void addCollisionCandidates(ArrayList<Ex01> partnerList)
  {
    for (Ex01 a : partnerList)
   ...
   */
  public ArrayList<Ex01> getNeighbours(double distance, Class clazz)
  {
    if (gameGrid == null)
      return null;
    ArrayList<Ex01> a = new ArrayList<Ex01>();
    for (Location loc : location.getNeighbourLocations(distance))
    {
      ArrayList<Actor> actors = gameGrid.getActorsAt(loc, clazz);
      for (Ex01 actor : actors)
        a.add(actor);
    }
    return a;
  }
   ...
   * @param distance the distance in (fractional) cell units  public
   */
  public ArrayList<Ex01> getNeighbours(double distance)
  {
